...
export const useCreateAgency = () => {
    ...
    const [succmesg, setSucmsg] = useState(null)
        ...
        const createAgency =  async (agencyname) => {
            ...
            try {
                ...
                if(storeditem !== null) {
                    ...
                    const response = await fetch(`${process.env.REACT_APP_API_URL}/user/createagency`, {
                        method: 'POST',
                        headers: {
        ...
        return { createAgency, loadingState, succmesg, error } 
}